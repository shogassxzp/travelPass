    ...
    var body: some View {
        ...
        ScrollView {
            VStack(alignment: .leading) {
                Text(LicenseConstants.title)
                    .font(.system(size: 24, weight: .bold))
                    .foregroundStyle(.yBlack)

                Text(LicenseConstants.documentInfo)
                    .font(.system(size: 17, weight: .regular))
                    .padding(.bottom, 24)
                    .foregroundStyle(.yBlack)

                Text(LicenseConstants.termsTitle)
                    .font(.system(size: 24, weight: .bold))
                    .padding(.bottom, 8)
                    .foregroundStyle(.yBlack)

                Text(LicenseConstants.termsText)
                    .font(.system(size: 17, weight: .regular))
                    .foregroundStyle(.yBlack)
            }
            .padding()
